...
import { add1, add1Async, add1WithoutRailwayResult, add2, add2Async, add2WithoutRailwayResult, add3, add3Async, add3WithoutRailwayResult, addFail, addFailAsync, append1, append1Async, append2, append2Async, append3, append3Async } from './helpers.js'
...
test('Call async / sync functions with success result', async () => {
  const result = await pipe(0, add1, chain(add2Async), chain(add3Async), chain(add1))
